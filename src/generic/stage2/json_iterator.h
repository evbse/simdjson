...
array_value_begin:
  ...
  if (jsoncharutils::char_is_number(buf[idx])) {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_number(*this, &buf[idx]) ); goto array_value_end;
  }
  if (buf[idx] == '"') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_string(*this, &buf[idx], false) ); goto array_value_end;
  }
  if (buf[idx] == 't') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_true_atom(*this, &buf[idx]) ); goto array_value_end;
  }
  if (buf[idx] == 'f') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_false_atom(*this, &buf[idx]) ); goto array_value_end;
  }
  if (buf[idx] == 'n') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_null_atom(*this, &buf[idx]) ); goto array_value_end;
  }
  if (buf[idx] == ']') {
    idx++;
    if (simdjson_likely(dom_parser.open_containers[depth].count == 0)) {
...
object_key_begin:
  ...
  if (simdjson_likely(buf[idx] == '"')) {
    SIMDJSON_TRY( visitor.visit_string(*this, &buf[idx], true) ); goto object_key_end;
  }
  if (simdjson_likely(buf[idx] == '}')) {
    idx++;
    if (simdjson_likely(simdjson_likely(dom_parser.open_containers[depth].count == 0))) {
...
object_value_begin:
  if (buf[idx] == '"') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_string(*this, &buf[idx], false) ); goto object_value_end;
  }
  if (jsoncharutils::char_is_number(buf[idx])) {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_number(*this, &buf[idx]) ); goto object_value_end;
  }
  if (buf[idx] == '{') {
    idx++;
    SIMDJSON_TRY( visitor.increment_count(*this) );
  ...
  if (buf[idx] == 't') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_true_atom(*this, &buf[idx]) ); goto object_value_end;
  }
  if (buf[idx] == 'f') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_false_atom(*this, &buf[idx]) ); goto object_value_end;
  }
  if (buf[idx] == 'n') {
    SIMDJSON_TRY( visitor.increment_count(*this) );
    SIMDJSON_TRY( visitor.visit_null_atom(*this, &buf[idx]) ); goto object_value_end;
  }
  if (jsoncharutils::char_is_space(buf[idx])) {
    idx++;
    while (jsoncharutils::char_is_space(buf[idx])) {
...
value_begin:
  if (jsoncharutils::char_is_number(buf[idx])) {
    SIMDJSON_TRY( visitor.visit_number(*this, &buf[idx]) ); goto document_end;
  }
  if (buf[idx] == '"') {
    SIMDJSON_TRY( visitor.visit_string(*this, &buf[idx], false) ); goto document_end;
  }
  if (buf[idx] == 't') {
    SIMDJSON_TRY( visitor.visit_true_atom(*this, &buf[idx]) ); goto document_end;
  }
  if (buf[idx] == 'f') {
    SIMDJSON_TRY( visitor.visit_false_atom(*this, &buf[idx]) ); goto document_end;
  }
  if (buf[idx] == 'n') {
    SIMDJSON_TRY( visitor.visit_null_atom(*this, &buf[idx]) ); goto document_end;
  }
  goto fail_value;
...
document_end:
  if (simdjson_unlikely(idx < dom_parser.len)) {
    ...
    if (simdjson_unlikely(idx < dom_parser.len)) goto fail_garbage;
  }
